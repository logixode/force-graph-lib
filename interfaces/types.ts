import { NodeObject as BaseNodeObject, LinkObject as BaseLinkObject, GraphData as BaseGraphData } from 'force-graph';
import { SimulationNodeDatum } from 'd3-force';

// Extend NodeObject from force-graph with our custom properties
export interface NodeData extends BaseNodeObject, SimulationNodeDatum {
  id: string | number;
  x?: number;
  y?: number;
  fx?: number;
