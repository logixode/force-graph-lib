  ...
  <div class="p-6 space-y-8">
    <div class="text-center">
      ...
      <div class="text-sm text-muted-foreground bg-muted/50 p-3 rounded-md max-w-2xl mx-auto">
        ...
        then use <code class="bg-background px-1 rounded">graph.renderer()</code> for direct access
        to all force-graph methods. No redundant wrapper methods needed!
      </div>
    </div>
    ...
    <div v-if="currentExampleInfo" class="bg-card p-4 rounded-lg border">
      ...
      <details class="text-sm">
        ...
        <pre
          class="bg-muted p-3 rounded text-xs overflow-x-auto"
        ><code>{{ currentExampleInfo.code }}</code></pre>
      </details>
    </div>
